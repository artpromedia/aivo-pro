        ...
        {filteredForms.map(form => (
          ...
          >
            ...
            <div className="mt-4 pt-4 border-t border-gray-200">
              {form.status === 'pending' && (
                <button className="w-full px-4 py-2 bg-gradient-to-r from-coral-500 to-salmon-500 text-white rounded-full hover:from-coral-600 hover:to-salmon-600 transition-all text-sm font-medium">
                  Review & Sign
                </button>
              )}
              {form.status === 'signed' && (
                <div className="flex gap-2">
                  <button className="flex-1 px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors text-sm font-medium">
                    <Eye className="w-4 h-4 mr-2 inline" />
                    View
                  </button>
                  <button className="flex-1 inline-flex items-center justify-center gap-2 px-3 py-2 border border-coral-300 text-coral-600 rounded-full hover:bg-coral-50 transition-colors text-sm font-medium">
