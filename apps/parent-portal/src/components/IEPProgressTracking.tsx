    ...
    const reportHTML = `
      ...
      <head>
        ...
        <style>
          ...
          h1 { color: #e05e5e; border-bottom: 3px solid #e05e5e; padding-bottom: 10px; }
          ...
          .progress-fill { background: linear-gradient(to right, #e05e5e, #ff8a8a); height: 100%; transition: width 0.3s; }
          .milestone { padding: 10px; margin: 10px 0; background: #f8f9fa; border-left: 4px solid #e05e5e; }
      ...
      <body>
          ...
          <div class="goal">
            ...
            ${goal.milestones.map(milestone => `
              <div class="milestone ${milestone.completed ? 'completed' : ''}">
                <strong>${milestone.title}</strong> ${milestone.completed ? '✓' : ''}
        ...
        <div class="footer">
          ...
          <p>For questions or concerns, please contact your child's IEP coordinator.</p>
        </div>
      </body>
      </html>
    `;
