...
class StripeWebhookHandler:
    ...
    async def handle_webhook(
        ...
        handlers = {
            ...
            WebhookEvent.SUBSCRIPTION_DELETED:
            ...
            WebhookEvent.PAYMENT_ACTION_REQUIRED:
                self.handle_payment_action_required,
            WebhookEvent.TRIAL_ENDING: self.handle_trial_ending,
        }

        try:
            event_key = WebhookEvent(event_type)
        except ValueError:
    ...
    async def handle_subscription_deleted(self, data: Dict) -> Dict:
        ...
        await self.notification_service.send_notification(
            ...
            data={
                ...
                "feedback_url": (
                    f"https://aivo.com/feedback?customer={customer_id}"
                )
            }
        )
    ...
    async def handle_payment_failed(self, data: Dict) -> Dict:
        ...
        await self.notification_service.send_notification(
            ...
            data={
                ...
                "update_url": (
                    f"https://aivo.com/billing/update?customer={customer_id}"
                )
            }
        )
    ...
    async def handle_trial_ending(self, data: Dict) -> Dict:
        ...
        await self.notification_service.send_notification(
            ...
            data={
                ...
                "plan_price": price_data['unit_amount'] / 100,
